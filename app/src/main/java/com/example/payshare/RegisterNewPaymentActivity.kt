...
class RegisterNewPaymentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val whoPay = ArrayList<String>()
        val forWho = ArrayList<String>()
        val membersList =  groupObj.getGroupMembers()

        //Adapter multiple choice per selezionare chi paga e per chi
        val lvAdapterChecked = ArrayAdapter(this, android.R.layout.simple_list_item_multiple_choice,membersList)
